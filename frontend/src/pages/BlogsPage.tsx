...
import {
  ...
  ChevronRight, Tag, TrendingUp, BookOpen
} from 'lucide-react';
  ...
  const posts: BlogPost[] = [
    {
      ...
      readTime: 8,
      views: 2500,
      tags: ['Elections', 'Democracy', 'Civic Education'],
    },
    {
      id: '2',
      title: 'Top 10 Performing Governors in 2024: A Data-Driven Analysis',
      excerpt: 'An in-depth analysis of gubernatorial performance across states based on infrastructure, education, and healthcare metrics.',
      content: '',
      category: 'Rankings',
      ...
      readTime: 12,
      views: 5600,
      tags: ['Governors', 'Performance', 'Analysis'],
    },
    {
      id: '3',
      title: 'The Role of Youth in Nigerian Politics: A New Dawn',
      excerpt: 'How young Nigerians are shaping the political landscape and what it means for the future of democracy.',
      content: '',
      category: 'Opinion',
      author: { name: 'Adebayo Johnson' },
      publishedAt: '2024-01-05',
      readTime: 6,
      views: 1800,
      tags: ['Youth', 'Politics', 'Future'],
    },
    {
      id: '4',
      title: 'Budget Analysis: Breaking Down the 2024 Federal Budget',
      excerpt: 'A detailed breakdown of the 2024 federal budget allocations and what it means for different sectors.',
      content: '',
      category: 'Analysis',
      ...
      readTime: 15,
      views: 3200,
      tags: ['Budget', 'Economy', 'Federal Government'],
    },
    {
      id: '5',
      title: 'Political Promises Tracker: How Are Our Leaders Doing?',
      excerpt: 'We track campaign promises and their fulfillment rates to hold politicians accountable.',
      content: '',
      ...
      readTime: 10,
      views: 4100,
      tags: ['Promises', 'Accountability', 'Tracking'],
    },
    {
      id: '6',
      title: 'Local Government Elections: Everything You Need to Know',
      excerpt: 'A guide to upcoming local government elections and why your vote at the grassroots level matters.',
      content: '',
      category: 'News',
      author: { name: 'Editorial Team' },
      ...
      readTime: 7,
      views: 2100,
      tags: ['Elections', 'Local Government', 'Voting'],
    },
  ];
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 -mt-12 mb-8">
          ...
          <div className="bg-white rounded-xl p-4 shadow-lg border border-gray-100">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-2xl font-bold text-gray-900">{posts.reduce((a, p) => a + p.views, 0).toLocaleString()}</p>
          ...
          <div className="bg-white rounded-xl p-4 shadow-lg border border-gray-100">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-2xl font-bold text-gray-900">{posts.filter(p => new Date(p.publishedAt) > new Date(Date.now() - 7 * 24 * 60 * 60 * 1000)).length}</p>
                ...
                {filteredPosts.map((post) => (
                  <div key={post.id} className="bg-white rounded-xl border border-gray-100 p-5 hover:shadow-md transition group">
                    <div className="flex gap-5">
                      <div className="hidden sm:block w-32 h-24 bg-gradient-to-br from-gray-200 to-gray-300 rounded-lg flex-shrink-0 flex items-center justify-center">
