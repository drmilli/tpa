...
exports.factCheckService = void 0;
...
class FactCheckService {
    ...
    async analyzeClaimWithAI(claim) {
        if (!this.openai) {
            logger_1.logger.warn('OpenAI not configured, returning mock response');
...
- unverifiable: Cannot be verified with available information`;
            ...
            logger_1.logger.info(`Fact check completed for claim: ${claim.substring(0, 50)}...`);
            return result;
        }
        catch (error) {
            logger_1.logger.error('Error in AI fact check:', error);
            return this.getMockResponse(claim);
        }
    }
    getMockResponse(_claim) {
...
exports.factCheckService = new FactCheckService();
//# sourceMappingURL=factcheck.service.js.map