...
async function main() {
    ...
    for (const office of offices) {
        const created = await prisma.office.upsert({
            ...
            update: { type: office.type, level: office.level, description: office.description },
            create: { name: office.name, type: office.type, level: office.level, description: office.description },
        });
